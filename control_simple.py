...
if __name__ == '__main__':
    ...
    pid_ch1 = PIDFFController(Kp = 3000, Ki = 0,Kd = 0, Kff = 0, i_max = 1, nonlinear_mode='squared')
    pid_ch2 = PIDFFController(Kp = 3000, Ki = 0, Kd = 0, Kff = 0, i_max = 1, nonlinear_mode='squared')
